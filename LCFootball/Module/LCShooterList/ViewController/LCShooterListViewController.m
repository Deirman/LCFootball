...
@interface LCShooterListViewController ()<OrderModeTabViewDelegate,UITableViewDelegate,UITableViewDataSource>
...
@implementation LCShooterListViewController
